    ...
    <script src="{{ asset('dashboard/assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside.min.js') }}">
    </script>
    ...
    <script src="{{ asset('dashboard/assets/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js') }}"></script>
    <script src="{{ asset('dashboard/assets/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js') }}">
    </script>
    ...
    <script src="{{ asset('dashboard/assets/vendor/clipboard/dist/clipboard.min.js') }}"></script>
    <script src="{{ asset('dashboard/assets/vendor/datatables/media/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('dashboard/assets/vendor/datatables.net.extensions/select/select.min.js') }}"></script>
    ...
    <script>
        ...
        HSCore.components.HSDatatables.init($('#datatable'), {
            ...
            language: {
              ...
              <img class="mb-3" src="{{ asset('dashboard/assets/svg/illustrations/oc-error.svg') }}" alt="Image Description" style="width: 10rem;" data-hs-theme-appearance="default">
              <img class="mb-3" src="{{ asset('dashboard/assets/svg/illustrations-light/oc-error.svg') }}" alt="Image Description" style="width: 10rem;" data-hs-theme-appearance="dark">

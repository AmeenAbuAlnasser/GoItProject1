                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" required value="{{ old('Name') }}" class="form-control" name="Name"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" required value="{{ old('Address') }}" class="form-control" name="Address"
